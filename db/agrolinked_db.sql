...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2025 at 08:57 PM
...
INSERT INTO `users` (`user_id`, `full_name`, `email`, `password`, `user_role`, `country`, `city`, `profile_image`, `phone`, `date_joined`) VALUES
(1, 'System Administrator', 'admin@agrolinked.com', '$2y$10$J7Mf1eWPoO/7oP8E8GT1u.Q4P7LZnUq0YhVBXvjPXh1dYQwC08vcy', 1, 'Ghana', 'Accra', NULL, '0240000000', '2025-11-30 17:24:47');
...
--
ALTER TABLE `vendor_profiles`
  ADD CONSTRAINT `vendor_profiles_ibfk_1` FOREIGN KEY (`vendor_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE;
COMMIT;
