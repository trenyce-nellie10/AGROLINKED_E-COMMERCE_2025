...
async function load(){
  ...
  grid.innerHTML = prods.map(p=>`
    <div class="card product-card">
      <img class="product-img" src="${p.image_path || 'assets/images/default.png'}">
      <h3>${p.title}</h3>
...
<body class="page bg-image"><?php include '../nav.php'; ?><main class="center-wrap"><section style="max-width:1100px;width:100%"><h2>Products</h2><div id="grid" style="display:flex;flex-wrap:wrap;gap:12px;"></div></section></main></body></html>
